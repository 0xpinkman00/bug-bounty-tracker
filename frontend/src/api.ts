...
export type ReleasePollRun = {id:string; status:'running'|'completed'|'completed_with_errors'; started_at:string; completed_at:string|null; total_repositories:number; checked_count:number; new_release_count:number; error_count:number; repositories:ReleasePollEntry[]};
